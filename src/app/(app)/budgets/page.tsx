...
export default async function BudgetsPage({ searchParams }: BudgetsPageProps) {
  ...
  return (
    <section className="space-y-8">
      <PageHeader
        eyebrow="Ngân sách"
        title="Hạn mức chi tiêu theo danh mục"
        description="Đặt số tiền dự kiến cho từng nhóm chi tiêu, theo dõi phần đã dùng trong tháng và chỉnh riêng khi một tháng có kế hoạch khác thường."
      />
