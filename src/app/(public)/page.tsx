  ...
  return (
    <main className="flex min-h-screen flex-col bg-background text-foreground">
      <section className="mx-auto grid w-full max-w-6xl flex-1 items-center gap-10 px-6 py-12 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="space-y-8">
          ...
          <div className="space-y-5">
            <h1 className="max-w-3xl text-5xl font-semibold tracking-normal sm:text-6xl">
              AI financial coach for everyday money.
            </h1>
          ...
          <div className="flex flex-wrap gap-3">
            <Button asChild className="h-11 bg-[#2F6B4F] hover:bg-[#285B43]">
              <Link href="/dashboard">
                Vào ứng dụng
            ...
            <Button asChild variant="outline" className="h-11 border-[#DDD8CE]">
              <Link href="/login">Đăng nhập</Link>
            </Button>
          </div>
          <div className="grid gap-3 text-sm text-muted-foreground sm:grid-cols-3">
            <p className="flex items-start gap-2">
              <BadgeCheck className="mt-0.5 size-4 shrink-0 text-[#2F6B4F]" />
        ...
        <div className="rounded-2xl border border-[#DCD7CC] bg-card p-5 shadow-[0_18px_60px_rgba(47,42,31,0.08)]">
          <div className="rounded-2xl border border-[#D8E1D7] bg-[#F3F8F2] p-5">
            ...
            <div className="mt-5 rounded-2xl border border-[#D8E1D7] bg-white/80 p-4 text-sm leading-6">
          ...
          <div className="mt-5 grid gap-3">
            {[
              ...
              <div
                key={label}
                className="flex items-center justify-between gap-4 rounded-xl border border-[#E8E4DC] bg-[#FDFCF8] px-4 py-3"
              >
